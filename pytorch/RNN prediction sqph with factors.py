...
regressor.add(tf.keras.layers.LSTM(units = 240, return_sequences = False, input_shape = (X_train.shape[1], X_train.shape[2])))
...
dataset_test_1 = pd.read_csv('SQPH Historical Data 2009-2017.csv').iloc[:,[1,7,11,12,13,14]]
dataset_test_1 = dataset_test_1.iloc[-60:,:] 
dataset_test_2 = pd.read_csv('SQPH Historical Data2018 practice.csv').iloc[:,[1,7,11,12,13,14]]
