...
scores = dqn()
torch.save(agent.qnetwork_local.state_dict(), 'checkpoint_qnetwork_local dropout.pth')
torch.save(agent.qnetwork_local.state_dict(), 'checkpoint_qnetwork_target dropout.pth')
...
agent.qnetwork_local.load_state_dict(torch.load('checkpoint_qnetwork_local dropout.pth'))
