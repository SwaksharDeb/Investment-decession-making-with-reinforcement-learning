...
classifier.fit(X_train, y_train, batch_size = 32,  validation_split=0.3, epochs = 200)
...
with open("GP classification with factor.json", "w") as json_file:
    json_file.write(classifier_json)

### Saving network weights
classifier.save_weights("GP classification with factor.json.h5")
